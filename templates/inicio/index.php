...
<body>
  ...
  <section class="container-fluid up2">
    ...
    <div style="text-decoration: none" class="main-text">
  ...
  <section class="top-card">
    <div class="rodadas jogador1" style="                 
     ...
     background-size: cover;"><br>
      ...
      href="estatiscas-neymar.php">Entrar</a></button>
    </div>
    ...
    <div class="rodadas jogador2" style="                 
     ...
     background-size: cover;"><br>
      <button><a style="text-decoration: none;"
      href="estatiscas-richarlisson.php">Entrar</a></button>
    </div>
    ...
    <div class="rodadas" style="                 
     ...
     background-size: cover;"><br>
      <button><a style="text-decoration: none;"
          href="estatiscas-viniciusjr.php">Entrar</a></button>
    </div>
  </section>
  ...
  <div class="text-center">
            <img src="./img/botoes/ultimas.svg" alt="">
        </div>
        <br>
  <section class="container up3">
    <div class="main3">
      <iframe width="50%" height="500vh" src="https://www.youtube.com/embed/Z-DEOw3JN2s" title="YouTube video player"
