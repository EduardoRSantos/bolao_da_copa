    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php?r=principal">World Cup</a>
            </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="index.php?r=inicio"><span class="glyphicon glyphicon glyphicon-log-out"></span>Sair</a></li>
            </ul>
        </div>
    </nav>
</body>
