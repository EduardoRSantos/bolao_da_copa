    ...
    <div id="main">
        <div class="container">
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h1 class="card-title"> Quem ficou em terceiro lugar na Copa do Mundo 2022?</h1>
                ...
                <div class="container">
                    <img width="100%" style="border-radius: 30px;"
                        src="https://www.lance.com.br/files/article_main/uploads/2022/12/17/639de4a6a787d.jpeg"
                        class="card-img-top" alt="...">
                </div>
                <div class="card-footer text-muted">
                    Croácia ficou com o terceiro lugar da Copa do Mundo 2022 (Foto: Paul ELLIS / AFP)
                </div>
            </div>
        </div>
        ...
        <div class="noticias-text">
            ...
            <h3>
                A Croácia ficou com o terceiro lugar da Copa do Mundo 2022. A seleção venceu o Marrocos por 2 a 1, neste
                sábado, e garantiu o último lugar do pódio. Gvardiol e Orsic marcaram os gols croatas na partida,
                enquanto
                Dari balançou as redes para os marroquinos.
            </h3>
            <br>
            <br>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item">
                    <a class="page-link" href="noticias1.php?r=noticias1">Next</a>
                </li>
            </ul>
        </nav>
</body>
