...
(33, '2022-12-03', '12:00', 'HON', 'EUA', 'INTERNACIONAL KHALIFA', 'OITAVAS DE FINAL', 'OITAVAS', 3, 1, 'ABERTO'),
(34, '2022-12-03', '16:00', 'ARG', 'AUS', 'AHMAD BIN ALI', 'OITAVAS DE FINAL', 'OITAVAS', 2, 1, 'ABERTO'),
(35, '2022-12-05', '12:00', 'JAP', 'CRO', 'AL JANOUB', 'OITAVAS DE FINAL', 'OITAVAS', 1, 1, 'ABERTO'),
(36, '2022-12-05', '16:00', 'BRA', 'COR', 'ESTADIO 974', 'OITAVAS DE FINAL', 'OITAVAS', 4, 1, 'ABERTO'),
(37, '2022-12-04', '16:00', 'ING', 'SEN', 'AL BAYT', 'OITAVAS DE FINAL', 'OITAVAS', 3, 0, 'ABERTO'),
(38, '2022-12-04', '12:00', 'FRA', 'POL', 'AL THUMAMA', 'OITAVAS DE FINAL', 'OITAVAS', 3, 1, 'ABERTO'),
(39, '2022-12-06', '12:00', 'MAR', 'ESP', 'CIDADE DA EDUCACAO', 'OITAVAS DE FINAL', 'OITAVAS', 0, 0, 'ABERTO'),
(40, '2022-12-06', '16:00', 'POR', 'SUI', 'LUSAIL', 'OITAVAS DE FINAL', 'OITAVAS', 6, 1, 'ABERTO'),
(41, '2022-12-09', '16:00', 'HOL', 'ARG', 'LUSAIL', 'QUARTAS DE FINAL', 'QUARTAS', 2, 2, 'ABERTO'),
(42, '2022-12-09', '12:00', 'CRO', 'BRA', 'CIDADE DA EDUCACAO', 'QUARTAS DE FINAL', 'QUARTAS', 1, 1, 'ABERTO'),
(43, '2022-12-10', '16:00', 'ING', 'FRA', 'AL BAYT', 'QUARTAS DE FINAL', 'QUARTAS', 1, 2, 'ABERTO'),
(44, '2022-12-10', '12:00', 'MAR', 'POR', 'AL THUMAMA', 'QUARTAS DE FINAL', 'QUARTAS', 1, 0, 'ABERTO'),
(45, '2022-12-13', '16:00', 'ARG', 'CRO', 'LUSAIL', 'SEMIFINAL', 'SEMIFINAL', 3, 0, 'ABERTO'),
(46, '2022-12-14', '16:00', 'FRA', 'MAR', 'AL BAYT', 'SEMIFINAL', 'SEMIFINAL', 2, 0, 'ABERTO'),
(47, '2022-12-18', '12:00', 'ARG', 'FRA', 'LUSAIL', 'FINAL', 'FINAL', 3, 3, 'ABERTO'),
...
--
ALTER TABLE `aposta`
  ADD CONSTRAINT `aposta_ibfk_1` FOREIGN KEY (`id_dados`) REFERENCES `dados_jogos` (`id`);
COMMIT;
